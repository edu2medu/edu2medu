        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="relative">
              ...
              {/* Standardized Title Card - Matches Astitva design structure */}
              <motion.div
              ...
              >
                <h1 className="text-2xl sm:text-3xl md:text-3xl font-extrabold text-[#17A2B8] tracking-tight mb-2">
                  {user.name}
                </h1>
                <div className="w-16 h-1 bg-[#17A2B8] opacity-30 mx-auto mb-4 rounded-full"></div>
                ...
                {/* Contact Summary Row - Compact style like in Astitva image */}
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-[13px] sm:text-sm text-gray-600 font-bold">
                  {user.phone && (
                    <div className="flex items-center gap-2">
                      <FaPhoneAlt className="text-[#17A2B8]" />
                      <span>Contact:{user.phone}</span>
                    </div>
                  )}
                  {user.address && (
                    <div className="flex items-center gap-2 text-left">
                      <FaMapMarkerAlt className="text-[#17A2B8] flex-shrink-0" />
            ...
            <div className="p-6 pt-10 sm:p-10 sm:pt-14 md:p-12 md:pt-16">
              ...
              <motion.div
                ...
                initial="hidden"
                animate={isLoaded ? "visible" : "hidden"}
                className="mb-6 bg-[#e0f7f9] p-4 sm:p-6 rounded-2xl border border-cyan-100"
              >
              ...
              <motion.div
                ...
                initial="hidden"
                animate={isLoaded ? "visible" : "hidden"}
                className="mb-6 bg-[#eaffee] p-4 sm:p-6 rounded-2xl border border-teal-50"
              >
                <div className="px-2 sm:px-6">
                  <h3 className="text-lg sm:text-xl font-bold text-teal-700 mb-2">About</h3>
              ...
              <motion.div
                ...
                initial="hidden"
                animate={isLoaded ? "visible" : "hidden"}
                className="mb-6 bg-[#e4f9fc] p-4 sm:p-6 rounded-2xl border border-cyan-50"
              >
                <div className="px-2 sm:px-6">
                  <h3 className="text-lg sm:text-xl font-bold text-cyan-700 mb-2">Amenity</h3>
                  <div className="text-sm sm:text-base">
              ...
              <motion.div
                ...
                initial="hidden"
                animate={isLoaded ? "visible" : "hidden"}
                className="mb-6 bg-[#f0fbff] p-4 sm:p-6 rounded-2xl border border-blue-50"
              >
                <div className="p-2 sm:p-4 md:p-6">
                  <h1 className="text-xl sm:text-2xl font-bold text-blue-800 mb-4">Specialist Information</h1>
              ...
              >
                <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                  <div className="bg-[#17A2B8] p-3 rounded-full shadow-md">
              ...
              >
                <button
                  className="w-full py-4 bg-[#17A2B8] text-white font-bold rounded-xl shadow-lg hover:bg-[#138496] transition duration-300 transform hover:-translate-y-1 hover:shadow-xl flex items-center justify-center gap-2"
