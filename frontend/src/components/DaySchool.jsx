...
function DaySchool() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col py-10 px-5">
      ...
      <div className="flex flex-col lg:flex-row mt-0 lg:mt-0 lg:pt-0 pt-0">
        {/* Left side filter box (Fixed on larger screens) */}
        <div className="lg:w-1/4 w-full bg-white p-6 rounded-lg shadow-lg sticky top-24 z-10 hidden lg:block h-screen overflow-y-auto">
        ...
        <div className="lg:w-3/4 mt-0 w-full pl-6  lg:mt-0 lg:h-screen overflow-y-auto">
          <h1 className="text-4xl font-bold lg:mt-0 text-black mb-4">Day School List near India</h1>
